...
let categoryCache = {
  ...
  getCache() {
    return storage.getItem(CATEGORY_LIST)
      ? JSON.parse(storage.getItem(CATEGORY_LIST))
      : [];
  }
};
...
let searchHistoryCache = {
  ...
  getCache() {
    return storage.getItem(SEARCH_HISTORY)
      ? JSON.parse(storage.getItem(SEARCH_HISTORY))
      : [];
  },
  deleteCache() {
...
let browseHistoryCache = {
  ...
  getCache() {
    return storage.getItem(BROWSE_HISTORY)
      ? JSON.parse(storage.getItem(BROWSE_HISTORY))
      : [];
  },
...
let tokenCache = {
  ...
  getCache() {
    return storage.getItem(USER_TOKEN)
      ? JSON.parse(storage.getItem(USER_TOKEN))
      : "";
  },
  deleteCache() {
...
let addressInfoCache = {
  ...
  getCache() {
    return storage.getItem(ADDRESS_INFO)
      ? JSON.parse(storage.getItem(ADDRESS_INFO))
      : {};
  },
  deleteCache() {
