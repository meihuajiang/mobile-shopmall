  ...
  <div class="comment">
    ...
    <section class="content">
      ...
      <b-scroll
        ...
        v-if="curTabIndex === 0 && waitCommentList.length"
        :data="waitCommentList"
      >
        <div class="container">
          <ul class="goods-list">
            <li
              class="goods-item"
              v-for="item of waitCommentList"
              :key="item._id"
            >
              ...
              <section class="goods-name">
                ...
                <div
                  class="comment-btn"
                  @click="goCommentGoods(item.goodsId, item._id, item.order_id)"
                >
                  <van-icon name="chat" />
                  <span>评论晒单</span>
                </div>
      ...
      <b-scroll class="content-scroll" v-else-if="curTabIndex === 1">
        <div class="container">
          <ul class="goods-list">
            <li
              class="goods-item"
              v-for="item of alreadyCommentList"
              :key="item._id"
            >
              <section class="goods-img">
...
export default {
  ...
  data() {
    return {
      commentBg: require("@/assets/imgs/comment.jpeg"),
      curTabIndex: 0,
